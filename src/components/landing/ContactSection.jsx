    ...
    <footer id="contact" className="relative overflow-hidden border-t border-border px-6 py-24 lg:px-10 lg:py-32" aria-labelledby="contact-title">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-12 lg:items-start">
        <div className="lg:col-span-7">
          ...
          <p className="mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground">Оставьте контакты в заявке или свяжитесь с — мы уточним задачу, формат объекта и предложим первый шаг: консультацию, концепцию или полный проект под ключ.
