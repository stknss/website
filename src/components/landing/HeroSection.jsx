    ...
    <section id="top" className="relative min-h-screen overflow-hidden border-b border-border" aria-labelledby="hero-title">
      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl grid-cols-1 items-center gap-12 px-6 py-24 lg:grid-cols-2 lg:gap-0 lg:px-10">
        ...
        <motion.div
          ...
          <img src="https://media.base44.com/images/public/6a25b90cc69d8cc1446d8488/60f8054af_ChatGPT_Image_13__2026___22_08_44.png"
        ...
        <motion.div
          ...
          <p className="mt-8 max-w-xl text-lg leading-relaxed text-muted-foreground">Создаем уникальные интерьеры с душой и вниманием к деталям. Полный цикл - от идеи до воплощения
