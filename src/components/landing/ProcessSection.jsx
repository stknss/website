    ...
    <section id="process" className="px-6 py-24 lg:px-10 lg:py-32" aria-labelledby="process-title">
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 grid gap-6 lg:grid-cols-12">
          ...
          <h2 id="process-title" className="font-display text-5xl font-light italic leading-none text-foreground md:text-7xl lg:col-span-7">Идея проходит по с инженерной системе
