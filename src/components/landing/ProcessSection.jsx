  ...
  return (
    <section id="process" className="px-6 py-24 lg:px-10 lg:py-32" aria-labelledby="process-title">
      <div className="mx-auto max-w-7xl">
        <Reveal className="mb-16 grid gap-6 lg:grid-cols-12">
          <p className="font-mono text-sm uppercase tracking-[0.28em] text-primary lg:col-span-3">Процесс под ключ</p>
          <h2 id="process-title" className="font-display text-5xl font-light italic leading-none text-foreground md:text-7xl lg:col-span-7">
            Идея проходит по строгой инженерной системе
          </h2>
        </Reveal>
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {steps.map(([number, title, text], i) =>
            <Reveal key={number} delay={i * 0.12} className="h-full">
              <article className="group min-h-72 h-full border border-border bg-card p-7 rounded-[1.5rem] transition duration-300 hover:-translate-y-2 hover:shadow-lg hover:border-primary/40">
