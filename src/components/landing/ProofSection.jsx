      ...
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-12 lg:items-stretch">
        <div className="lg:col-span-5">
          <motion.div
            ...
            className="grid h-full grid-cols-2 gap-px overflow-hidden rounded-[2rem] border border-border bg-border sm:grid-cols-3">
            ...
            map((stat) =>
            <div key={stat.label} className={`flex flex-col justify-center bg-card p-8 ${stat.wide ? 'col-span-2 sm:col-span-3' : ''}`}>
        ...
        <div className="lg:col-span-7">
          ...
          <h2 id="proof-title" className="font-display text-5xl font-light italic leading-none text-foreground md:text-7xl">В нашей работе баланс: взгляд архитектора и подход инженера-строителя
