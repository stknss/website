...
'Офисы и шоурумы',
'Проекты малоэтажной архитектуры'];
    ...
    <main className="min-h-screen bg-background text-foreground">
      <section className="px-6 pt-24 pb-24 lg:px-10 lg:pb-32">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-4 font-display text-4xl font-light italic leading-none md:text-6xl">Команда профессионалов в сфере{'\u00A0'}интерьерного дизайна
          ...
          <div className="mt-10 space-y-6 text-lg leading-relaxed text-muted-foreground">
            ...
            <p>
              За годы работы мы реализовали более 75 проектов, часть из которых была отмечена в
