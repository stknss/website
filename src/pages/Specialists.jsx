      ...
      <section className="px-6 pt-24 pb-24 lg:px-10 lg:pb-32" aria-labelledby="specialists-title">
        ...
        <div className="mx-auto mt-16 max-w-7xl">
          <div className="rounded-[2rem] border border-border bg-card p-8 md:p-12">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-relaxed text-muted-foreground">Мы — муж и жена, архитектор-дизайнер и инженер-строитель. Это значит, что проект проходит двойной контроль: художественный и технический. И мы рядом на всём пути от эскиза до финальной уборки перед вашим новосельем.от эскиза до финальной уборки перед вашим новосельем.
