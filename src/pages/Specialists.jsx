        ...
        <div className="mx-auto mt-16 max-w-7xl">
          <div className="rounded-[2rem] border border-border bg-card p-8 md:p-12">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-relaxed text-muted-foreground">
              Мы — муж и жена, архитектор и инженер. Это значит, что проект проходит двойной контроль:
              художественный и технический. Мы не делим обязанности на «творческие» и «скучные» — каждый
              этап важен одинаково. И мы рядом на всём пути: от эскиза до финальной уборки перед вашим
              новосельем.
            </p>
          </div>
        </div>
