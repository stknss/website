...
},
{
  ...
  description:
  'За 30 лет работы в строительной сфере, Сергей прошел путь от прораба до руководителя крупных строек, в число которых входят торговые центры, спортивные сооружения, заводы и даже атомная электростанция. Перейдя от крупных строительных проектов в сферу частных заказов, Сергей стал отвечать за то, чтобы задуманная красота проекта держалась на точном расчёте и правильной реализации. Весь накопленный опыт успешно реализуется в каждом отдельном проекте — он знает каждый узел, каждый норматив и умеет договориться с подрядчиками так, чтобы объект был сдан в срок и без сюрпризов.'
}];
