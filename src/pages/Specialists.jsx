...
},
{
  ...
  description:
  'За все время работы в строительной сфере, Сергей прошел путь от мастера до руководителя крупных строек, в число которых входят жилые дома, спортивные сооружения, заводы. Перейдя в сферу частных заказов, Сергей стал отвечать за то, чтобы задуманная красота проекта держалась на точном расчёте и правильной реализации. Весь опыт и знания успешно учитываются в каждом отдельном проекте — он знает каждый узел, каждый норматив и умеет договориться с подрядчиками так, чтобы объект был сдан в срок и без сюрпризов.'
}];
